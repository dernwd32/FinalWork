...
public class CourseCardHeaderComponent  extends AbstractComponent {
    ...
    private String newDuration = subHeaderInfoBlockRoot + "//*[local-name()='path' and @d='" + imgDurationD + "']//following::p[1]";
    private String oldDuration = "//div[@src='/_next/static/images/img/one-7074d31f3a086caefed9ae2a24ebd55f.svg']//following::div[1]";
    private String newFormat = subHeaderInfoBlockRoot + "//*[local-name()='path' and @d='" + imgFormatD + "']//following::p[1]";
